...
ULTRALYTICS_CONFIG_DIR = Path.cwd() / "outputs" / "part_b" / "ultralytics_config"
            ...
            for image_path, result in zip(chunk, predictions):
                ...
                if result.boxes is not None and len(result.boxes) > 0:
                    ...
                    for i in range(len(boxes)):
                        ...
                        if selected is None or conf > selected[0]:
                            selected = (conf, xyxy)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="outputs/part_b", help="Output root.")
