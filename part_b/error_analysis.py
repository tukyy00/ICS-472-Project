...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--predictions-csv", default="outputs/part_b/test_eval/predictions.csv")
    parser.add_argument("--output-dir", default="outputs/part_b/error_analysis/test_eval")
