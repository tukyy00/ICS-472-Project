...
def run(args: argparse.Namespace) -> None:
    ...
    model = ResNetBiLSTMCTC(dropout=float(checkpoint.get("dropout", 0.1))).to(device)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--checkpoint", default="outputs/part_b/checkpoints/best_crnn_ctc.pt")
    parser.add_argument("--output-dir", default="outputs/part_b/eval")
