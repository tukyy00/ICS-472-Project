...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest", default="arabic_check_pipeline/part_b_courtesy_ocr/outputs/train_manifest.csv")
    parser.add_argument("--output-dir", default="arabic_check_pipeline/part_b_courtesy_ocr/outputs/checkpoints")
    ...
    parser.add_argument("--arch", choices=["deep16", "resnet18"], default="deep16")
